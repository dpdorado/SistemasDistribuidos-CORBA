 ...
 * @author andres
 */
public class DatosORB extends javax.swing.JFrame {

    /**
     * Creates new form DatosORB
     */
    public DatosORB() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtPuerto = new java.awt.TextField();
        label3 = new java.awt.Label();
        txtUrlServidor = new java.awt.TextField();
        ...
        label1.setText("DATOS DEL ORB");

        label2.setAlignment(java.awt.Label.RIGHT);
        label2.setText("NUMERO DE PUERTO");

        txtPuerto.setText("1080");

        label3.setAlignment(java.awt.Label.RIGHT);
        label3.setText("URL ORB");

        txtUrlServidor.setText("localhost");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtPuerto, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(label3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtUrlServidor, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtPuerto.getText().equals("") || txtUrlServidor.getText().equals("")) {
            ...
            try {
                ...
                if (puerto < 1024) {
                    JOptionPane.showMessageDialog(this, "El puerto debe ser moyor o igual a 1024.", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
...
//                    cliente.gui.IniciarSesion is = new IniciarSesion(Constantes.ORBInitialHost, Constantes.ORBInitialPort);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatosORB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private java.awt.TextField txtPuerto;
    private java.awt.TextField txtUrlServidor;
